    ...
    return (
      <section className="hero-section">
        <div className="hero-content-container container">
          <h1>ศูนย์รวมเครื่องมือช่าง<br />&amp; เครื่องจักรก่อสร้าง</h1>
          <p className="hero-subtitle">ขาย-เช่า ครบ จบที่เดียว</p>
        ...
        <div className="hero-slide active" style={{ 
          ...
          <div className="hero-overlay">
            <div className="hero-content-container container">
              ...
              {slide.subheadline && <p className="hero-subtitle">{slide.subheadline}</p>}
              <div className="hero-buttons">
                <a href="tel:0657898285" className="btn btn-primary">โทรเลย</a>
